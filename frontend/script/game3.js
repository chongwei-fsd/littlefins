...
let totalBalance3=balance;// Initialize total balance
...
function updateCoin(decision=0) {
    ...
    totalBalance3 = balance + decision;
    displayBalance.innerText = totalBalance3; // Update the balance text
}
...
nextBtn.addEventListener('click',function(){
    ...
    localStorage.setItem('balance3',totalBalance3)
