class VoucherController {
    ...
    addVoucher(voucher) {
        ...
        redeemBtn.onclick = () => this.handleRedeemClick(voucher.id, redeemBtn);
    ...
    handleRedeemClick(voucherId, redeemBtn) {
        // console.log(voucherId)
        // redeemBtn.closest('div.col-12').remove();
        redeemVoucher(voucherId,redeemBtn); //post api redeem voucher
