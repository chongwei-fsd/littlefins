...
//        Redeemed usedVoucher=findvoucher.get();
//        usedVoucher.setIs_redeemed(true);
//        usedVoucher.setDate_used(LocalDate.now());
//        redeemedService.save(usedVoucher);
//
//        long randomNumber = ThreadLocalRandom.current().nextLong(1000000000L, 10000000000L);
//
//        RedeemedResponse redeemedResponse=new RedeemedResponse();
//        redeemedResponse.setVoucher(usedVoucher.getVoucher());
//        redeemedResponse.setRandomNum(randomNumber);
//        redeemedResponse.setDateUsed(usedVoucher.getDate_used());
//        return new ResponseEntity<>(redeemedResponse, HttpStatus.OK);
